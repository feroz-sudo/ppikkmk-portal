...
function SidebarNavContent({
    ...
    isWeeklyFormsOpen,
    toggleWeeklyForms,
    isInternshipFormsOpen,
    toggleInternshipForms,
    isInternshipLogOpen,
    toggleInternshipLog,
    setIsSidebarOpen,
    isMobile
            ...
            {userRole === "admin" ? (
                ...
                <>
                    ...
                    <div className="pt-4 space-y-2">
                        ...
                        {Object.entries(sessionsGrouped).map(([sessionName, trainees]: any) => (
...
export default function DashboardLayout({
    ...
    useEffect(() => {
        ...
        } else if (pathname?.startsWith('/dashboard/forms') || pathname?.startsWith('/dashboard/internship')) {
            setIsFormsOpen(true);
        }
    }, [pathname]);
                ...
                <main className="flex-1 overflow-y-auto p-6 bg-white">
                    <Suspense fallback={
                        <div className="flex flex-col items-center justify-center min-h-[400px]">
                            ...
                            <p className="text-xs font-black text-slate-400 uppercase tracking-widest">Building Dashboard...</p>
                        </div>
                    }>
                        {children}
