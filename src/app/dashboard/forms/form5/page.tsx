            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8 bg-white overflow-x-auto">
                    ...
                    <div className="bg-white p-6 border-2 border-black space-y-6">
                        <h2 className="text-xl font-bold text-black uppercase underline decoration-2 underline-offset-4">DEMOGRAPHIC INFORMATION</h2>
                        <div className="grid grid-cols-[180px_auto_1fr] md:grid-cols-[240px_auto_1fr] gap-4 items-center pl-4">
                            ...
                            <div className="font-bold text-black uppercase">Gender</div><div className="font-bold">:</div>
                            <select value={gender} onChange={e => setGender(e.target.value)} className={inputClasses}><option value="Male">Male</option><option value="Female">Female</option></select>
